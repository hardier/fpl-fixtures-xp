...
Checklist for submitting the **FPL Fixtures & xP** extension (v1.0.4) to the Chrome Web Store.  
The packaged zip is ready at `dist/fpl-fixtures-xp-1.0.4.zip` (34 KB, 14 files).
...
3. Upload the zip file `dist/fpl-fixtures-xp-1.0.4.zip`.
