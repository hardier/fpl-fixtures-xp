...
Checklist for submitting the **FPL Squad Selection Helper** extension (v1.2.0) to the Chrome Web Store.  
The packaged zip is ready at `dist/fpl-squad-selection-helper-1.2.0.zip` (34 KB, 14 files).
...
3. Upload the zip file `dist/fpl-squad-selection-helper-1.2.0.zip`.
