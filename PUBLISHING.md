...
Checklist for submitting the **FPL Squad Selection Helper** extension (v1.1.3) to the Chrome Web Store.  
The packaged zip is ready at `dist/fpl-squad-selection-helper-1.1.3.zip` (34 KB, 14 files).
...
3. Upload the zip file `dist/fpl-squad-selection-helper-1.1.3.zip`.
